...
import CompletedRequestsCustomer from "./pages/customer/CompletedRequests"; // Renamed for clarity
import CompletedRequestsServiceProvider from "./pages/service-provider/CompletedRequests"; // Import service provider version
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <Routes>
            ...
            <Route path="/forget" element={<ForgetPassword showNotification={showNotification} />} />
